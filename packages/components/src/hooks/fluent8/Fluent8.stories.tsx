  ...
  return (
    <div style={container}>
      <div style={controls}>
        <div style={pair}>
          <div style={label}>
            <a href="https://developer.microsoft.com/en-us/fluentui#/controls/web/label">Label</a>
          </div>
          <div style={control}>
        ...
        <div style={pair}>
          ...
          <div style={control}>
            <ActionButton {...mediumActionButtonProps}>Create item</ActionButton>
          </div>
          <div style={control}>
        ...
        <div style={pair}>
          <div style={label}>
            <a href="https://developer.microsoft.com/en-us/fluentui#/controls/web/slider">Slider</a>
          </div>
          <div style={control}>
        ...
        <div style={pair}>
          <div style={label}>
            <a href="https://developer.microsoft.com/en-us/fluentui#/controls/web/toggle">Toggle</a>
          </div>
          <div style={control}>
        ...
        <div style={pair}>
          ...
          <div style={control}>
            <ChoiceGroup label="Label" selectedKey={'first'} {...mediumChoiceGroupProps} />
          </div>
          <div style={control}>
            <ChoiceGroup label="Label" selectedKey={'first'} {...smallChoiceGroupProps} />
          </div>
        </div>
        <div style={pair}>
          <div style={label}>
        ...
        <div style={pair}>
          <div style={label}>
            <a href="https://developer.microsoft.com/en-us/fluentui#/controls/web/pivot">Pivot</a>
          </div>
          <div style={control}>
        ...
        <div style={pair}>
          <div style={label}>
            <a href="https://developer.microsoft.com/en-us/fluentui#/controls/web/nav">Nav</a>
          </div>
          <div style={sideby}>
            <div style={control}>
